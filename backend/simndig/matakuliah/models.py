...
class MataKuliah(models.Model):
    ...
    mahasiswa = models.ManyToManyField(
        User, related_name='mata_kuliah_diambil')
    ...
    def upload_tugas(self, mahasiswa, tugas_id, file):
        ...
        try:
            ...
            raise ValidationError(
                "Tugas tidak ditemukan untuk mata kuliah ini.")
    ...
    def _nilai_tugas(self, tugas_id, mahasiswa_id, nilai, feedback=None):
        ...
        try:
            pengumpulan = PengumpulanTugas.objects.get(
                tugas=tugas, mahasiswa_id=mahasiswa_id)
